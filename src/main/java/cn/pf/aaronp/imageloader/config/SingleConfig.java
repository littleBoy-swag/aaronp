...
public class SingleConfig {
    ...
    public static class ConfigBuilder {
        ...
        public ConfigBuilder override(int oWidth, int oHeight) {
            this.oWidth = FunctionUtil.dp2px(context, oWidth);
            this.oHeight = FunctionUtil.dp2px(context, oHeight);
            return this;
        }
         ...
         * 形状为圆角矩形时的圆角半径
         *
         * @param rectRoundRadius rectRoundRadius
         * @return
         */
        public ConfigBuilder rectRoundCorner(int rectRoundRadius) {
            this.rectRoundRadius = FunctionUtil.dp2px(context, rectRoundRadius);
