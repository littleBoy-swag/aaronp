...
public class LockView extends View {
    ...
    public LockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (attr == R.styleable.LockView_normalColor) {
                normalColor = array.getColor(attr, Color.GRAY);

            } else if (attr == R.styleable.LockView_selectColor) {
                selectColor = array.getColor(attr, Color.YELLOW);

            } else if (attr == R.styleable.LockView_correctColor) {
                correctColor = array.getColor(attr, Color.GREEN);

            } else if (attr == R.styleable.LockView_wrongColor) {
                wrongColor = array.getColor(attr, Color.RED);

            } else if (attr == R.styleable.LockView_lineWidth) {
