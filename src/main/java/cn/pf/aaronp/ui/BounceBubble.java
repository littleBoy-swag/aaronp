 ...
 * desc: 弹性小球 似乎存在内存泄漏的问题--后期改进
 */

public class BounceBubble extends View {
    String TAG = "BounceBubble";
    //动画开关
    ...
    public BounceBubble(Context context) {
        super(context);
        mContext = context;
    ...
    public BounceBubble(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        mColor = context.getResources().getColor(R.color.colorPrimary);
        init();
