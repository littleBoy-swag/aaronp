package cn.pf.aaronp.utils.bleutils;
...
import cn.pf.aaronp.utils.HexUtil;
import cn.pf.aaronp.utils.bleutils.callback.BleDevceScanCallback;
import cn.pf.aaronp.utils.bleutils.callback.ConnectCallback;
import cn.pf.aaronp.utils.bleutils.callback.OnReceiverCallback;
import cn.pf.aaronp.utils.bleutils.callback.OnWriteCallback;
import cn.pf.aaronp.utils.bleutils.callback.ScanCallback;
import cn.pf.aaronp.utils.bleutils.request.ReceiverRequestQueue;
...
public class BleController {
    ...
    //TODO 此处根据不同业务来进行修改，由业务方提供
    public static final String UUID_SERVICE = "0000fff0-0000-1000-8000-00805f9b34fb";
    public static final String UUID_INDICATE = "0000fff6-0000-1000-8000-00805f9b34fb";
    public static final String UUID_NOTIFY = "0000fff6-0000-1000-8000-00805f9b34fb";
    public static final String UUID_WRITE = "0000fff6-0000-1000-8000-00805f9b34fb";
    public static final String UUID_READ = "0000fff6-0000-1000-8000-00805f9b34fb";
